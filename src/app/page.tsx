    ...
    <StyleWrapper>
      <PageShell>
        <section className="flex flex-col justify-center relative min-h-[70vh] py-10">
          ...
          {/* Nav Back Home (Since header is gone, we don't need header but we need nav) 
                Wait, this is Home Page. We need links to Work/About.
            */}
          <AnimatedSection className="mb-12 flex justify-between items-center text-xs uppercase tracking-[0.2em] text-zinc-400 relative z-50">
            {/* Conditional name: Hide in Brutalist/Editorial as they have their own big headers */}
